      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutDesc>
            ...
            Software engineering is one of my favorite hobbies, I enjoy architecting large scale web and mobile applications,
             from UI/UX to code modularity and reusability. I get annoyed by poor UI/UX choice, therefore I use frameworks and
              libraries such as React and Angular to the next level.
          </AboutDesc>
        </Inner>
      </Content>
